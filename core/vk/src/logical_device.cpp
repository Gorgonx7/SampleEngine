...
#include "global_static_config.hpp"
#include "instance.hpp"
#include "state.hpp"
logical_device::logical_device(instance *vk_instance, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, bool validation_layers_enabled, VkQueue *graphicsQueue, VkQueue *presentQueue)
{
    createLogicalDevice(vk_instance, physicalDevice, surface, validation_layers_enabled, graphicsQueue, presentQueue);
}
VkDevice logical_device::get_device()
{
    return vk_device;
}
...
void logical_device::createLogicalDevice(instance *vk_instance, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, bool validation_layers_enabled, VkQueue *graphicsQueue, VkQueue *presentQueue)
{
